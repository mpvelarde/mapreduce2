...
"""task4bmapper1.py: Receives an xml file. Outputs aid\tptype for posts or pid\tptype\tuid for answers
        ...
        if line:
            ...
            if int(post_type_id) == 1: # if post is question
                ...
                if accepted_answer_id != '':
                    print "%s%s%s%s%s" % (accepted_answer_id, separator, post_type_id, separator, post_id)
